...
<asm version="1.0" name="0">
	<cp>
		...
		<constant value="A.__matchdropTransition():V"/>
		<constant value="__exec__"/>
		<constant value="dropTransition"/>
		<constant value="NTransientLinkSet;.getLinksByRule(S):QNTransientLink;"/>
		<constant value="A.__applydropTransition(NTransientLink;):V"/>
		...
		<constant value="__matchdropTransition"/>
		...
		<constant value="__applydropTransition"/>
	...
	<operation name="118">
		...
		<linenumbertable>
			...
			<lne id="134" begin="25" end="38"/>
		</linenumbertable>
		<localvariabletable>
			<lve slot="1" name="127" begin="6" end="40"/>
	...
	<operation name="135">
		...
		<localvariabletable>
			<lve slot="2" name="127" begin="3" end="3"/>
			<lve slot="0" name="26" begin="0" end="3"/>
			<lve slot="1" name="138" begin="0" end="3"/>
		</localvariabletable>
	</operation>
</asm>
