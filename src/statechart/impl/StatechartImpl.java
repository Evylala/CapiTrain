 ...
 * </p>
 * <ul>
 *   <li>{@link statechart.impl.StatechartImpl#getTopState <em>Top State</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StatechartImpl extends MinimalEObjectImpl.Container implements Statechart {
	...
	public NotificationChain basicSetTopState(AND newTopState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StatechartPackage.STATECHART__TOP_STATE, oldTopState, newTopState);
	...
	public void setTopState(AND newTopState) {
		if (newTopState != topState) {
			...
			if (topState != null)
				msgs = ((InternalEObject)topState).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - StatechartPackage.STATECHART__TOP_STATE, null, msgs);
			if (newTopState != null)
				msgs = ((InternalEObject)newTopState).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - StatechartPackage.STATECHART__TOP_STATE, null, msgs);
			msgs = basicSetTopState(newTopState, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StatechartPackage.STATECHART__TOP_STATE, newTopState, newTopState));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StatechartPackage.STATECHART__TOP_STATE:
